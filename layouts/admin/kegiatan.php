<?php
    ...
    $dataKegiatan = mysqli_query($koneksi,$queryKegiatan);
    ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- Content Row -->
                        <div class="row">
                            <?php foreach ($dataKegiatan as $datas) { ;?>
                            <div class="col-lg-12">
                                <div class="card mb-4 py-3 border-left-primar">                          
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo $datas['kegiatan'];?></h5>
                                        <p class="card-text"><?php echo $datas['deskripsi'];?></p>
                                        <p class="card-text"><small class="text-body-secondary"><?php echo $datas['waktu'];?></small></p>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
